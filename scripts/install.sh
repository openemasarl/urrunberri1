...
#  Branch : test-network-module (GTK WebView — sans Firefox)
# =============================================================================

set -e

GITHUB_RAW="https://raw.githubusercontent.com/openemasarl/urrunberri1/test-network-module"
...
info "=== Branche : test-network-module (GTK WebView) ==="
...
branche=test-network-module
VERSIONEOF
info "Version installee : $APP_VERSION ($INSTALL_DATE) [branche test-network-module]"
...
# ── DOWNLOAD APP FILES ────────────────────────────────────────────────────────
info "Telechargement des fichiers depuis GitHub (branche test-network-module)..."
...
info "=== Installation terminee (branche test-network-module — GTK WebView) ==="
